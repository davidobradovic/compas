    ...
    <div className='w-full'>
      <div className='dash-page'>
        ...
        <div className='main-details m-3 flex items-center gap-3 flex-wrap'>
          <div className='main-detail bg-gray-50 p-3' style={{ width: 'calc(50% - 10px)' }}>
        ...
        <div className="w-full m-3 latest-orders">
          <div className='latest-order-navigation flex items-center gap-5'>
